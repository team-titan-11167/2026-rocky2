...
public interface SuperstructureIO {
  ...
  public static class SuperstructureIOInputs {
    ...
    public double leftIntakeLauncherPositionRad = 0.0;
    public double leftIntakeLauncherVelocityRadPerSec = 0.0;
    public double leftIntakeLauncherAppliedVolts = 0.0;
    public double leftIntakeLauncherCurrentAmps = 0.0;

    public double rightIntakeLauncherPositionRad = 0.0;
    public double rightIntakeLauncherVelocityRadPerSec = 0.0;
    public double rightIntakeLauncherAppliedVolts = 0.0;
    public double rightIntakeLauncherCurrentAmps = 0.0;
  }
