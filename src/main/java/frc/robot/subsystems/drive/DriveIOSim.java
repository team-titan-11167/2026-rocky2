...
public class DriveIOSim implements DriveIO {
  ...
  public void updateInputs(DriveIOInputs inputs) {
    ...
    Logger.recordOutput("Simulation/RobotPose", sim.getPose());
  }

  /** Returns the physics model's ground-truth pose for tests and simulation diagnostics. */
